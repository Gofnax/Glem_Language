...
_lr_productions = [
  ...
  ('expression -> expression EQUAL expression','expression',3,'p_expression_binop','parser.py',52),
  ...
  ('expression -> BOOLEAN','expression',1,'p_expression_boolean','parser.py',77),
  ('expression -> IDENTIFIER','expression',1,'p_expression_identifier','parser.py',82),
  ('expression -> LAMBDA IDENTIFIER . expression','expression',4,'p_expression_lambda','parser.py',87),
  ('function_definition -> MEY LCURLY IDENTIFIER COMMA LPAREN arg_list RPAREN RCURLY expression SEMICOLON','function_definition',10,'p_function_definition','parser.py',92),
  ('arg_list -> IDENTIFIER','arg_list',1,'p_arg_list','parser.py',100),
  ('arg_list -> IDENTIFIER COMMA arg_list','arg_list',3,'p_arg_list','parser.py',101),
  ('expression -> IDENTIFIER LPAREN arg_list RPAREN','expression',4,'p_expression_function_call','parser.py',109),
]
